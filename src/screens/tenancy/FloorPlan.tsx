...
import PropertyCard from '../../components/ui/cardHome';
...
const FloorPlanDetails = () => {
    ...
    return (
        <MainWithHeader title={'Floor Plan'}
        ...
        >
            <>
                ...
                >
                    <Image source={Images.FLOORPLAN} style={styles.imageStyle} resizeMode='contain' />
                </TouchableOpacity>
                {imageView === true ? (
                    < ImageView
                        images={images}
