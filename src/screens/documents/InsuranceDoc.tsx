...
type Props = StackNavigationProp<PropertyDocumentsStackParamList, 'InsuranceDoc'>
...
const InsuranceDoc = () => {
    ...
    const { propertyComplianceDocuments: { insuranceDoc }, propertyId } = useSelector((state: any) => state.property);
    ...
    const { handleChange, handleSubmit, handleBlur, values, errors, setFieldValue } = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            await saveDataWithDocumentName('insuranceDocument', collectionReference, values)
            dispatch(setPropertyCompliance({ insuranceDocument: values }))
        }
    })
    return (
        <MainWithHeader title="Insurance documents"
        ...
        >
            <>
                ...
                <InputBox inputTitle="Please enter your certificate issue date" dropdown={true} />
