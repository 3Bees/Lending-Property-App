...
type Props = StackNavigationProp<PropertyDocumentsStackParamList, 'EICRDocument'>
...
const EICRDocument = () => {
    ...
    const { propertyComplianceDocuments: { eicrReport }, propertyId } = useSelector((state: any) => state.property);
    ...
    const initialValues = {
      ...
      const { handleChange, handleSubmit, handleBlur, values, errors, setFieldValue } = useFormik({
        ...
        onSubmit: async (values) => {
          ...
          await saveDataWithDocumentName('eicrReport', collectionReference, values)
          dispatch(setPropertyCompliance({ eicrReport: values }))
        }
      })
    
    return (
        <MainWithHeader title="EICR Document Report"
        ...
        >
            <>
                ...
                <InputBox
                    ...
                    dropdown={false} value={values.reference}                />
                <Box mt={3}>
