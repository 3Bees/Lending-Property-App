...
type Props = StackNavigationProp<PropertOnboardingStackParamList, 'AddPropertyImages'>
...
const AddPropertyImages = () => {
  ...
  return (
    <MainWithHeader title="Property Details"
      onClickBack={() => navigation.goBack()}
    >
      <Box style={{ flex: 1, justifyContent: 'space-between' }}>
        <Box style={styles.InnerContainer}>
          <SubHeading
            subTitle="Adding photos of your property will attract more tenants. We suggest you include all rooms and any outside space your property has."
          />
        ...
        <Box alignItems="center" marginTop={'38%'}>
          ...
          <Box>
            <PrevAndNextButtons
              onClickBack={() => navigation.goBack()}
              onClickNext={() => navigation.navigate('PropertyImagesPreview', {resourcePath:resourcePath})}
            />
          </Box>
        </Box>
      </Box>
