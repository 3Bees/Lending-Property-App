...
import { propertyDetail, buttonPropertyDetail } from '../../assets/dataset/dataset'
...
type NavigationProps = StackNavigationProp<PropertiesStackParamList, 'PropertyHomeDetails'>
...
const PropertyHomeDetails = ({ route }: Props) => {
    ...
    const { params: { address } } = useRoute<ParamsType>();
        ...
        onClickBack={()=>navigation.goBack()}>
            <Box mt={4} >
                ...
                <View style={styles.cardRow}>
                    <Card title="Delete Property" image={Images.DELETE} onPress={() => { DeleteProp() }} />
                    <Card title="Edit Property" image={Images.EDIT} onPress={() => { navigation.navigate('EditProperty') }} />
                </View>
                <View style={styles.cardRow}>
                    <Card title="Compliance CheckList" image={Images.EDIT} onPress={() => { DeleteProp() }} />
                    <Card title="Property Services" image={Images.CART} onPress={() => { navigation.navigate('PropertyServicesList') }} />
                </View>
            </Box>
