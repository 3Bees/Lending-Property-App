...
type NavigationProps = StackNavigationProp<PropertOnboardingStackParamList, 'PropertyImagesPreview'>
type ParamsType = RouteProp<PropertOnboardingStackParamList, 'PropertyImagesPreview'>
...
const PropertyImagesPreview = () => {
  ...
  const { params: { resourcePath } } = useRoute<ParamsType>();
  return (
