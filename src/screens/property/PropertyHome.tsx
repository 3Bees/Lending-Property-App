...
import PropertyHomeComponent from '../../components/ui/propertyHomeComponent';
import { propertyHome } from '../../assets/dataset/dataset'
  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        <AnimatedHeader animatedValue={offset} backgroundImage={Images.PROPERTYMAIN} />
                  ...
                  renderItem={({ item }) => {
                    return (
                      <PropertyHomeComponent
                        ...
                        onPress={() => { navigation.navigate('PropertyHomeDetails', { address: item.propertname }) }}
                      />
                    )
                  }
                  }
        ...
        <Box flex={0} alignItems="center" justifyContent={'flex-end'} mb="2" backgroundColor={'#fff'}>
          <NavigationButton
            text="Add a property"
            btnStyle={{
