...
import { ProfileDetailsCard } from '../../components/ui/profileDetails'
...
const UserDetails = () => {
    ...
    const [img, setImage] = useState('https://randomuser.me/api/portraits/men/76.jpg')
    const [name, setName] = useState('John Smith')
    const [email, setEmail] = useState('johnsmith@witbit.uk')
    const [contactno, setContactno] = useState('+44 7711223344')
    const [password, setPassword] = useState('Change Password')
    const [currentAdd, setCurrentAdd] = useState('123 Clean Street Menchester\nM1 1DD')
        ...
        >
            ...
            <View style={styles.body}>
                ...
                <ProfileDetailsCard
                    ...
                    ChangePass={() => { navigation.navigate('ChangePass') }}
                />
                <ProfileDetailsCard
