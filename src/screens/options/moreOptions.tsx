import {  StyleSheet, SafeAreaView, View, ScrollView, Animated, Image } from 'react-native';
                ...
                <Box style={styles.cardContainer}>
                    ...
                    >
                        ...
                        <View style={styles.cardRow}>
                            <Card title="Add your first Property" image={Images.HomePlus} onPress={() => { navigation.navigate('OnboardingProperty') }} />
                        </View>
