...
const rentDepositFormValidation = (values: any,data: any) => {
    ...
    if (values.deposit > 30) {
        errorList.deposit = "Sorry the property is not suitable for the amount of tenants selected" 
    }
    ...
    if (values.rent < 10) {
        errorList.rent = "Sorry this offer is much lower than  the minimum allowed advertised rent  £10 "
    }
