...
import { View, TouchableOpacity, Text, PermissionsAndroid, Platform, StyleSheet, Modal } from 'react-native';
      ...
      <View style={styles.modalMain}>
        <View style={styles.imageModalContainer}>
          <TouchableOpacity style={styles.closeContainer} onPress={onClose}>
            <AntDesign name="closecircle" size={responsiveHeight(3.5)} color="#000000" />
          </TouchableOpacity>
          <View style={styles.buttonContainer}>
            <TouchableOpacity
              style={styles.picOption}
              onPress={openCameraFromModal}>
              <MaterialIcons name="photo-camera" size={responsiveWidth(7)} color="black" />
            ...
            <TouchableOpacity
              ...
              <MaterialIcons name="insert-photo" size={responsiveWidth(7)} color="black" />
