import { SET_PROPERTY_DATA,SET_APPOINTMENT_DATA, SET_RENTAL_OFFER, SET_PROPERTY_COMPLIANCE_DATA } from "../constants/propertyConstants";
...
const property = (state = initialState, action: { type: any; payload: any; }) => {
  switch (action.type) {
    ...
    case SET_RENTAL_OFFER:
      return { ...state, appointmentId: { ...state.appointmentId, rentalOffer: action.payload } };
    default:
      return state;
  }
};
